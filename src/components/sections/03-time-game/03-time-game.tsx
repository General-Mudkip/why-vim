...
export const TimeGame = () => {
    ...
    return (
        <section
            ref={ref}
            id="03-time-game"
            className="flex font-share h-screen w-full gap-y-12 flex-col justify-center items-center"
        >
            <p>
                But first, a quick game. Rest your
                <span
                    title="Your second finger."
                    className="font-bold underline decoration-dotted cursor-help inline px-1.5"
                >
                    index finger
                </span>
                on the{" "}
