...
const pressableButtonVariants = cva(
    "flex font-fira transition-all duration-100 rounded-sm items-center justify-center",
    {
        variants: {
            variant: {
                default:
                    "border-2 border-neutral-800 shadow-[inset_0_-3px_0_0_rgba(0,0,0,0.2)]",
                default_for_game:
                    "border-2 border-neutral-800 shadow-[inset_0_-3px_0_0_rgba(0,0,0,0.2)]",
                pulsing:
                    "border-2 animate-bg-pulse border-neutral-800 bg-neutral-100 shadow-[inset_0_-3px_0_0_rgba(0,0,0,0.2)]",
                success:
                    "border-2 border-green-800 bg-green-200 text-green-900 shadow-[inset_0_-3px_0_0_rgba(0,100,0,0.2)]",
                wrong: "border-2 border-dashed bg-red-100 text-red-800 border-red-800 transform shadow-[inset_0_-3px_0_0_rgba(100,0,0,0.2)]",
                to_be_pressed:
                    "border-2 border-dashed border-orange-800 text-orange-900 bg-orange-200 shadow-[inset_0_-4px_0_0_rgba(50,0,0,0.2)]",
            },
            size: {
        ...
        <span
            className={cn(
                pressableButtonVariants({
                    variant: effectiveVariant,
                    active: keyIsActive,
                    class: "h-13 w-40 justify-between px-4 border-2",
                }),
            )}
        >
